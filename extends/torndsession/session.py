...
class SessionManager(object):
    ...
    def __init__(self, handler): #handler is a HomeHandler forexample which one has the SessionManager
        #print("Session Manager init",self,handler)
...
class SessionMixin(object):
    ...
    def _create_mixin(self, context, inner_property_name, session_handler):
        #print("_create_mixin",self,context)
